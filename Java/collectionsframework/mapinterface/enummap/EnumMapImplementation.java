...
public class EnumMapImplementation {
    ...
    // by their ordinal(index of internal array in Enum) and because of this map entry will also be ordered
    // by their ordinal
    ...
    public static void main(String[] args) {
        ...
        // order inside map -> Monday, Friday, because ordinal of Monday comes before Friday in its respective enum
